...
export default {
  ...
  params: {
    touch: {
      ...
      materialRipple: true,
      materialRippleElements: '.ripple, a.link, a.item-link, .links-list a, .button, button, .dialog-button, .tab-link, .label-radio, .label-checkbox, .actions-modal-button, a.searchbar-clear, a.floating-button, .floating-button > a, .speed-dial-buttons a, .form-checkbox, .form-radio, .data-table .sortable-cell',
    },
  },
  static: {
    TouchRipple,
