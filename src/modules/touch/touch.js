...
export default {
  ...
  params: {
    touch: {
      ...
      materialRipple: true,
      materialRippleElements: '.ripple, a.link, a.item-link, .links-list a, .button, button, .dialog-button, .tab-link, .item-radio, .item-checkbox, .actions-button, a.searchbar-clear, a.floating-button, .floating-button > a, .speed-dial-buttons a, .checkbox, .radio, .data-table .sortable-cell',
    },
  },
  static: {
    TouchRipple,
