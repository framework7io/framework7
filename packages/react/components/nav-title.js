...
var F7NavTitle = function (_React$Component) {
  _inherits(F7NavTitle, _React$Component);

  function F7NavTitle(props, context) {
    _classCallCheck(this, F7NavTitle);

    return _possibleConstructorReturn(this, (F7NavTitle.__proto__ || Object.getPrototypeOf(F7NavTitle)).call(this, props, context));
  }
  ...
  _createClass(F7NavTitle, [{
    ...
    value: function render() {
      ...
      if (self.subtitle) {
        subtitleEl = _react2.default.createElement('span', {
          className: 'subtitle'
        }, subtitle);
      }
...
(0, _reactComponentSetProps2.default)(F7NavTitle, Object.assign({
  id: [String, Number],
  title: String,
  subtitle: String,
  sliding: Boolean
