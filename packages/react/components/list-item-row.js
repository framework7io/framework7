...
var F7ListItemRow = function (_React$Component) {
  _inherits(F7ListItemRow, _React$Component);

  function F7ListItemRow(props, context) {
    _classCallCheck(this, F7ListItemRow);

    return _possibleConstructorReturn(this, (F7ListItemRow.__proto__ || Object.getPrototypeOf(F7ListItemRow)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7ListItemRow, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7ListItemRow;