...
var F7CardHeader = function (_React$Component) {
  _inherits(F7CardHeader, _React$Component);

  function F7CardHeader(props, context) {
    _classCallCheck(this, F7CardHeader);

    return _possibleConstructorReturn(this, (F7CardHeader.__proto__ || Object.getPrototypeOf(F7CardHeader)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7CardHeader, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7CardHeader;