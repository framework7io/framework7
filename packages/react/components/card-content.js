...
var F7CardContent = function (_React$Component) {
  _inherits(F7CardContent, _React$Component);

  function F7CardContent(props, context) {
    _classCallCheck(this, F7CardContent);

    return _possibleConstructorReturn(this, (F7CardContent.__proto__ || Object.getPrototypeOf(F7CardContent)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7CardContent, Object.assign({
  id: [String, Number],
  padding: {
    type: Boolean,
    default: true
