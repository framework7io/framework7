...
var F7BlockFooter = function (_React$Component) {
  _inherits(F7BlockFooter, _React$Component);

  function F7BlockFooter(props, context) {
    _classCallCheck(this, F7BlockFooter);

    return _possibleConstructorReturn(this, (F7BlockFooter.__proto__ || Object.getPrototypeOf(F7BlockFooter)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7BlockFooter, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7BlockFooter;