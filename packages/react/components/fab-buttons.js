...
var F7FabButtons = function (_React$Component) {
  _inherits(F7FabButtons, _React$Component);

  function F7FabButtons(props, context) {
    _classCallCheck(this, F7FabButtons);

    return _possibleConstructorReturn(this, (F7FabButtons.__proto__ || Object.getPrototypeOf(F7FabButtons)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7FabButtons, Object.assign({
  id: [String, Number],
  position: {
    type: String,
    default: 'top'
