...
var F7BlockTitle = function (_React$Component) {
  _inherits(F7BlockTitle, _React$Component);

  function F7BlockTitle(props, context) {
    _classCallCheck(this, F7BlockTitle);

    return _possibleConstructorReturn(this, (F7BlockTitle.__proto__ || Object.getPrototypeOf(F7BlockTitle)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7BlockTitle, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7BlockTitle;