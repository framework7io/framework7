...
var F7AccordionContent = function (_React$Component) {
  ...
  function F7AccordionContent(props, context) {
    ...
    return _possibleConstructorReturn(this, (F7AccordionContent.__proto__ || Object.getPrototypeOf(F7AccordionContent)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7AccordionContent, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7AccordionContent;