...
var F7AccordionToggle = function (_React$Component) {
  ...
  function F7AccordionToggle(props, context) {
    ...
    return _possibleConstructorReturn(this, (F7AccordionToggle.__proto__ || Object.getPrototypeOf(F7AccordionToggle)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7AccordionToggle, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7AccordionToggle;