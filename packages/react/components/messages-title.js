...
var F7MessagesTitle = function (_React$Component) {
  _inherits(F7MessagesTitle, _React$Component);

  function F7MessagesTitle(props, context) {
    _classCallCheck(this, F7MessagesTitle);

    return _possibleConstructorReturn(this, (F7MessagesTitle.__proto__ || Object.getPrototypeOf(F7MessagesTitle)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7MessagesTitle, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7MessagesTitle;