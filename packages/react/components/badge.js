...
var F7Badge = function (_React$Component) {
  _inherits(F7Badge, _React$Component);

  function F7Badge(props, context) {
    _classCallCheck(this, F7Badge);

    return _possibleConstructorReturn(this, (F7Badge.__proto__ || Object.getPrototypeOf(F7Badge)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7Badge, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7Badge;