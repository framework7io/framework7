...
var F7Popup = function (_React$Component) {
  _inherits(F7Popup, _React$Component);

  function F7Popup(props, context) {
    _classCallCheck(this, F7Popup);

    var _this = _possibleConstructorReturn(this, (F7Popup.__proto__ || Object.getPrototypeOf(F7Popup)).call(this, props, context));
...
(0, _reactComponentSetProps2.default)(F7Popup, Object.assign({
  id: [String, Number],
  tabletFullscreen: Boolean,
  opened: Boolean
}, _mixins2.default.colorProps));

exports.default = F7Popup;