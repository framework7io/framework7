...
var F7Views = function (_React$Component) {
  _inherits(F7Views, _React$Component);

  function F7Views(props, context) {
    _classCallCheck(this, F7Views);

    return _possibleConstructorReturn(this, (F7Views.__proto__ || Object.getPrototypeOf(F7Views)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7Views, Object.assign({
  id: [String, Number],
  tabs: Boolean
}, _mixins2.default.colorProps));

exports.default = F7Views;