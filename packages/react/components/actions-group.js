...
var F7ActionsGroup = function (_React$Component) {
  _inherits(F7ActionsGroup, _React$Component);

  function F7ActionsGroup(props, context) {
    _classCallCheck(this, F7ActionsGroup);

    return _possibleConstructorReturn(this, (F7ActionsGroup.__proto__ || Object.getPrototypeOf(F7ActionsGroup)).call(this, props, context));
  }
  ...
  _createClass(F7ActionsGroup, [{
    ...
    value: function render() {
      ...
      var classes = _utils2.default.classNames.apply(_utils2.default, [className, 'actions-group'].concat(_toConsumableArray(_mixins2.default.colorClasses(props))));
...
(0, _reactComponentSetProps2.default)(F7ActionsGroup, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7ActionsGroup;