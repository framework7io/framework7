...
var F7LoginScreenTitle = function (_React$Component) {
  ...
  function F7LoginScreenTitle(props, context) {
    ...
    return _possibleConstructorReturn(this, (F7LoginScreenTitle.__proto__ || Object.getPrototypeOf(F7LoginScreenTitle)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7LoginScreenTitle, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7LoginScreenTitle;