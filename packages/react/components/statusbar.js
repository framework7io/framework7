...
var F7Statusbar = function (_React$Component) {
  _inherits(F7Statusbar, _React$Component);

  function F7Statusbar(props, context) {
    _classCallCheck(this, F7Statusbar);

    return _possibleConstructorReturn(this, (F7Statusbar.__proto__ || Object.getPrototypeOf(F7Statusbar)).call(this, props, context));
  }

  _createClass(F7Statusbar, [{
    key: 'render',
...
(0, _reactComponentSetProps2.default)(F7Statusbar, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7Statusbar;