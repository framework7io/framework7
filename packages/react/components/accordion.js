...
var F7Accordion = function (_React$Component) {
  _inherits(F7Accordion, _React$Component);

  function F7Accordion(props, context) {
    _classCallCheck(this, F7Accordion);

    return _possibleConstructorReturn(this, (F7Accordion.__proto__ || Object.getPrototypeOf(F7Accordion)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7Accordion, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7Accordion;