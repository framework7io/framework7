...
var F7ListItemCell = function (_React$Component) {
  _inherits(F7ListItemCell, _React$Component);

  function F7ListItemCell(props, context) {
    _classCallCheck(this, F7ListItemCell);

    return _possibleConstructorReturn(this, (F7ListItemCell.__proto__ || Object.getPrototypeOf(F7ListItemCell)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7ListItemCell, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7ListItemCell;