...
var F7BlockHeader = function (_React$Component) {
  _inherits(F7BlockHeader, _React$Component);

  function F7BlockHeader(props, context) {
    _classCallCheck(this, F7BlockHeader);

    return _possibleConstructorReturn(this, (F7BlockHeader.__proto__ || Object.getPrototypeOf(F7BlockHeader)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7BlockHeader, Object.assign({
  id: [String, Number]
}, _mixins2.default.colorProps));

exports.default = F7BlockHeader;