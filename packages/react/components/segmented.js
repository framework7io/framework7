...
var F7Segmented = function (_React$Component) {
  _inherits(F7Segmented, _React$Component);

  function F7Segmented(props, context) {
    _classCallCheck(this, F7Segmented);

    return _possibleConstructorReturn(this, (F7Segmented.__proto__ || Object.getPrototypeOf(F7Segmented)).call(this, props, context));
  }
  ...
  _createClass(F7Segmented, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(SegmentedTag, {
        id: id,
        style: style,
...
(0, _reactComponentSetProps2.default)(F7Segmented, Object.assign({
  id: [String, Number],
  raised: Boolean,
  round: Boolean,
  tag: {
