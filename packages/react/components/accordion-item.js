...
var F7AccordionItem = function (_React$Component) {
  _inherits(F7AccordionItem, _React$Component);

  function F7AccordionItem(props, context) {
    _classCallCheck(this, F7AccordionItem);

    return _possibleConstructorReturn(this, (F7AccordionItem.__proto__ || Object.getPrototypeOf(F7AccordionItem)).call(this, props, context));
  }
...
(0, _reactComponentSetProps2.default)(F7AccordionItem, Object.assign({
  id: [String, Number],
  opened: Boolean
}, _mixins2.default.colorProps));

exports.default = F7AccordionItem;