...
export default {
  ...
  mounted() {
    const self = this;
    const {init, searchContainer, searchIn, searchItem, hideOnEnableEl, hideOnSearchEl, foundEl, notFoundEl, backdrop, backdropEl, disableButton, ignore, customSearch, removeDiacritics, hideDividers, hideGroups, form} = self.props;
    if (!init)
      return;
