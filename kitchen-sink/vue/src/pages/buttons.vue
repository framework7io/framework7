<template>
  <f7-page>
    <f7-navbar title="Buttons" back-link></f7-navbar>
    ...
    <f7-block strong inset>
      ...
      <p class="grid grid-cols-3 grid-gap">
        <f7-button fill color="pink">Pink</f7-button>
        <f7-button fill color="yellow">Yellow</f7-button>
        <f7-button fill color="orange">Orange</f7-button>
      </p>
      <p class="grid grid-cols-3 grid-gap">
        <f7-button fill color="black">Black</f7-button>
        <f7-button fill color="white">White</f7-button>
      </p>
    </f7-block>
  </f7-page>
</template>
...
export default {
  ...
  setup() {
    ...
    return { isLoading1, isLoading2, load1, load2 };
  },
};
</script>
