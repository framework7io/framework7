<template>
  <f7-page :page-content="false">
    ...
    <f7-toolbar :position="toolbarPosition" tabbar labels>
      ...
      <f7-link tab-link="#tab-2" text="Tab 2" icon-ios="f7:calendar_fill" icon-md="material:today"></f7-link>
      <f7-link tab-link="#tab-3" text="Tab 3" icon-ios="f7:cloud_upload_fill" icon-md="material:file_upload"></f7-link>
    </f7-toolbar>
