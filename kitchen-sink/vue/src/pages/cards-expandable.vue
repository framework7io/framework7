  ...
  <f7-page>
    ...
    <f7-card expandable>
      <f7-card-content :padding="false">
        ...
        <div class="card-content-padding">
          ...
          <p>
            <f7-button fill round big card-close color="red">Close</f7-button>
          </p>
        </div>
      </f7-card-content>
    </f7-card>
    ...
    <f7-card expandable>
      <f7-card-content :padding="false">
        ...
        <div class="card-content-padding">
          ...
          <p>Framework7 is definitely for you if you decide to build iOS and Android hybrid app (Cordova or PhoneGap) or web app that looks like and feels as great native iOS or Android (Material) apps.</p>
          <p>
            <f7-button fill round big card-close color="yellow" text-color="black">Close</f7-button>
          </p>
        </div>
      </f7-card-content>
    </f7-card>
    ...
    <f7-card expandable>
      <f7-card-content :padding="false">
        ...
        <f7-link card-close color="white" class="card-opened-fade-in" :style="{position: 'absolute', right: '15px', top: '15px'}" icon-f7="close_round_fill"></f7-link>
        <f7-card-header text-color="black" :style="{height: '60px'}">Beach, Goa</f7-card-header>
        <div class="card-content-padding">
          ...
          <p>
            <f7-button fill round big card-close>Close</f7-button>
          </p>
        </div>
      </f7-card-content>
    </f7-card>
