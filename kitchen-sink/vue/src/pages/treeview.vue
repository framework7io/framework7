<template>
  <f7-page>
    <f7-navbar title="Treeview" back-link />

    <f7-block-title>Basic tree view</f7-block-title>
    <f7-block strong inset class="no-padding-horizontal">
      <f7-treeview>
...
export default {
  components: { f7Page, f7Navbar, f7BlockTitle, f7Block, f7Treeview, f7TreeviewItem, f7Checkbox },
  data() {
    return {
      checkboxes: {
