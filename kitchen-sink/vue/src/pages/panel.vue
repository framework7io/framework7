<template>
  <f7-page id="panel-page">
    <f7-navbar title="Panel / Side panels" back-link></f7-navbar>
    ...
    <f7-block strong inset>
      <p class="grid grid-cols-2 grid-gap">
        <f7-button round fill panel-open="left"> Open left panel </f7-button>
        <f7-button round fill panel-open="right"> Open right panel </f7-button>
      </p>
      <p>
        <f7-button round fill panel-open="#panel-nested"> Open nested panel </f7-button>
      </p>
    </f7-block>
  </f7-page>
</template>
...
export default { components: { f7Navbar, f7Page, f7Block, f7Button, f7Link, f7Panel } };
</script>
