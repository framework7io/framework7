<template>
  <f7-page>
    <f7-navbar title="Range Slider" back-link></f7-navbar>

    <f7-block-title>Volume</f7-block-title>
    <f7-list simple-list strong inset>
      <f7-list-item>
        <div>
    ...
    <f7-block strong inset class="display-flex justify-content-center">
      <f7-range
        class="margin-right"
        style="height: 160px"
        :vertical="true"
...
export default {
  components: { f7Navbar, f7Page, f7BlockTitle, f7Range, f7List, f7ListItem, f7Icon, f7Block },
  data() {
