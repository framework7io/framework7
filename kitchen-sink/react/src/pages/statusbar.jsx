    ...
    return (
      <Page>
        ...
        <Block strong>
          ...
          <Row tag="p">
            <Button raised className="col" onClick={this.showStatusbar.bind(this)}>Show Statusbar</Button>
            <Button raised className="col" onClick={this.hideStatusbar.bind(this)}>Hide Statusbar</Button>
          </Row>
        </Block>
      </Page>
    );
