    ...
    <Card expandable>
      <CardContent padding={false}>
        ...
        <div className="card-content-padding">
          ...
          <p>
            <Button fill round big cardClose color="red">Close</Button>
          </p>
        </div>
      </CardContent>
    </Card>
    ...
    <Card expandable>
      <CardContent padding={false}>
        ...
        <div className="card-content-padding">
          ...
          <p>Framework7 is definitely for you if you decide to build iOS and Android hybrid app (Cordova or PhoneGap) or web app that looks like and feels as great native iOS or Android (Material) apps.</p>
          <p>
            <Button fill round big cardClose color="yellow" textColor="black">Close</Button>
          </p>
        </div>
      </CardContent>
    </Card>
    ...
    <Card expandable>
      <CardContent padding={false}>
        ...
        <div className="card-content-padding">
          ...
          <p>
            <Button fill round big cardClose>Close</Button>
          </p>
        </div>
      </CardContent>
    </Card>
