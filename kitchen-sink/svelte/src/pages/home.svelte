...
<Page class="page-home">
  ...
  <List class="components-list searchbar-found">
    ...
    <ListItem link="/badge/" title="Badge"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/buttons/" title="Buttons"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/calendar/" title="Calendar / Date Picker">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/cards/" title="Cards"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/cards-expandable/" title="Cards Expandable">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/checkbox/" title="Checkbox"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/chips/" title="Chips/Tags"><i class="icon icon-f7" slot="media" /></ListItem>
    ...
    <ListItem link="/dialog/" title="Dialog"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/elevation/" title="Elevation">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/fab/" title="FAB"><i class="icon icon-f7" slot="media" /></ListItem>
    ...
    <ListItem link="/gauge/" title="Gauge"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/grid/" title="Grid / Layout Grid">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/icons/" title="Icons"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/infinite-scroll/" title="Infinite Scroll">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/inputs/" title="Inputs"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/lazy-load/" title="Lazy Load">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/list/" title="List View"><i class="icon icon-f7" slot="media" /></ListItem>
    ...
    <ListItem link="/radio/" title="Radio"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/range/" title="Range Slider"><i class="icon icon-f7" slot="media" /></ListItem>
    ...
    <ListItem link="/stepper/" title="Stepper"><i class="icon icon-f7" slot="media" /></ListItem>
    ...
    <ListItem link="/tabs/" title="Tabs"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/text-editor/" title="Text Editor">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/timeline/" title="Timeline"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/toast/" title="Toast"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/toggle/" title="Toggle"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/toolbar-tabbar/" title="Toolbar & Tabbar">
      <i class="icon icon-f7" slot="media" />
    </ListItem>
    <ListItem link="/tooltip/" title="Tooltip"><i class="icon icon-f7" slot="media" /></ListItem>
    <ListItem link="/treeview/" title="Treeview"><i class="icon icon-f7" slot="media" /></ListItem>
