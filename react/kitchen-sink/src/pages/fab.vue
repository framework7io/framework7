<template>
  <Page>
    ...
    <div className="fab fab-right-top" slot="fixed">
      <a href="#">
      ...
      <div className="fab-buttons fab-buttons-left">
        <a href="">1</a>
        <a href="">2</a>
        <a href="">3</a>
      </div>
    </div>
    <div className="fab fab-right-bottom" slot="fixed">
      <a href="#">
        <i className="icon f7-icons ios-only">add</i>
        <i className="icon f7-icons ios-only">close</i>
        <i className="icon material-icons md-only">add</i>
    ...
    <div className="fab fab-left-bottom" slot="fixed">
      <a href="#">
        <i className="icon f7-icons ios-only">add</i>
        <i className="icon f7-icons ios-only">close</i>
        <i className="icon material-icons md-only">add</i>
      ...
      <div className="fab-buttons fab-buttons-right">
        <a href="">1</a>
        <a href="">2</a>
        <a href="">3</a>
      </div>
    </div>
    <div className="fab fab-left-top" slot="fixed">
      <a href="#">
        <i className="icon f7-icons ios-only">add</i>
        <i className="icon f7-icons ios-only">close</i>
        <i className="icon material-icons md-only">add</i>
      ...
      <div className="fab-buttons fab-buttons-bottom">
        <a href="">1</a>
        <a href="">2</a>
        <a href="">3</a>
      </div>
    </div>
    <div className="fab fab-center-center" slot="fixed">
      <a href="#">
        <i className="icon f7-icons ios-only">add</i>
        <i className="icon f7-icons ios-only">close</i>
        <i className="icon material-icons md-only">add</i>
      ...
      <div className="fab-buttons fab-buttons-center" slot="fixed">
        <a href="">1</a>
        <a href="">2</a>
        <a href="">3</a>
        <a href="">4</a>
